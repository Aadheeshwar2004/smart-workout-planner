...
// /* ===================== WORKOUTS (✅ SINGLE SOURCE OF TRUTH) ===================== */
// export const workoutsAPI = {
//   create: (data: any) => api.post<Workout>("/workouts", data),

//   getAll: (skip = 0, limit = 100) =>
//     api.get<Workout[]>(`/workouts?skip=${skip}&limit=${limit}`),

//   getStreak: () => api.get<StreakData>("/streaks"),
...
// import axios from 'axios';
// import type { User, UserMetrics, Workout, Notification, Reward, AIRecommendations, StreakData, Analytics } from '@/types';
...
// // Workouts
// export const workoutsAPI = {
//   create: (data: Omit<Workout, 'id' | 'date'>) => api.post<Workout>('/workouts', data),
//   getAll: (skip = 0, limit = 100) => api.get<Workout[]>(`/workouts?skip=${skip}&limit=${limit}`),
//   getStreak: () => api.get<StreakData>('/streaks'),
//   getRewards: () => api.get<Reward[]>('/rewards'),
// };
...
// // AI
// export const aiAPI = {
//   getRecommendations: (prompt: string) => api.post<AIRecommendations>('/ai/recommendations', { prompt }),
//   analyzeProgress: (days = 30) => api.get(`/ai/progress-analysis?days=${days}`),
// };

// // Notifications
// export const notificationsAPI = {
//   getAll: () => api.get<Notification[]>('/users/notifications'),
//   markAsRead: (id: number) => api.put(`/users/notifications/${id}/read`),
// };
